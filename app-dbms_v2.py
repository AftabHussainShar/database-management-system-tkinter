...
class DBMSApp(tk.Tk):
    ...
    def populate_ins_name_dropdown(self):
        try:
            ...
            self.ins_name_entry['values'] = [""] + ins_names  # Adding empty option
        except mysql.connector.Error as err:
    ...
    def fetch_and_filter_data_2(self):
        ...
        query = "SELECT medicare_number, first_name, last_name, dob, address , payer,provider_name FROM raw WHERE 1=1"
        ...
        try:
            ...
            # Convert fetched data to DataFrame
            self.filtered_data = pd.DataFrame(rows, columns=['medicare_number', 'first_name', 'last_name', 'dob', 'address','payer','provider_name'])
        ...
        try:
            ...
            if file_path and selected_columns:
                ...
                for index, row in df.iterrows():
                    ...
                    query = (
                        "INSERT INTO checked (first_name, last_name, medicare_number, dob, gender, address, city, state, zip, ins_name, ins_type,active_date) "
